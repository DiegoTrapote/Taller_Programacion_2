...
/**
 * Ventana que permite generar un informe de los mecánicos
 * pertenecientes a una escudería específica.
 *
 * Funcionalidades:
 * - Permite seleccionar una escudería.
...
public class Informe_Mecanico extends javax.swing.JFrame {
    ...
    Servicios servicio;
      /** Ventana de la cual proviene esta pantalla (para volver atrás). */
    Informes volver;
    /**
     * Constructor de la interfaz de informe de mecánicos.
     *
     * @param servicio servicio que administra los datos de la aplicación.
     * @param volver ventana previa para regresar al menú de informes.
     */
     ...
     * Permite al usuario elegir una para mostrar sus mecánicos.
     */
    ...
    private void initComponents() {
        ...
        tablaResultados.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nombre", "Apellido", "Año de esperiencia", "Especialidad"
            }
        ) {
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(cbEscuderias, javax.swing.GroupLayout.PREFERRED_SIZE, 152, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
     ...
     * Busca y lista los mecánicos de la escudería seleccionada.
     */
